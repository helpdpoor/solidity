...
contract BorrowingLending is Borrowing, Lending, Admin {
    /**
     * Error messages:
     ...
     * 23 - Not allowed for this address
     * 24 - Wrong collateralProfileIndex
     * 25 - Collateral profile is blocked
     * 26 - Amount should be greater than zero
     * 27 - Collateral profile is not found
     * 28 - Collateral profile is blocked
     * 29 - For this type of collateral only internal transfers available
     * 30 - Not enough available to withdraw collateral
     * 31 - This collateral is liquidated
     * 32 - Collateral profile is not found
     * 33 - Not allowed for this address
     * 34 - Wrong collateralProfileIndex
     * 35 - Collateral profile is blocked
     * 36 - Not enough available to withdraw collateral
     * 37 - This collateral is liquidated
     * 38 - Collateral profile is not found
     * 39 - Collateral profile is blocked
     * 40 - This collateral is liquidated
     + lending.sol
     ...
     * 79 - caller is not the liquidation contract
     * 791 - Liquidation contract address can not be zero
     * utils.sol
