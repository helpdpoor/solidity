...
contract Collateral is Utils {
    ...
    function setUsdRateData (
        ...
        _usdRates[contractAddress].externalRate = externalRate;
    ...
    */
    ...
    function getUsdRateData (
        ...
        uint256 rate, uint256 updatedAt, bool externalRate
    ) {
        return (
            _usdRates[contractAddress].rate,
            _usdRates[contractAddress].updatedAt,
            _usdRates[contractAddress].externalRate
        );
    }
    ...
    function _getUsdRate (
        ...
        if (!_usdRates[contractAddress].externalRate) return _usdRates[contractAddress].rate;
