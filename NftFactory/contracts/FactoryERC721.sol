...
contract FactoryERC721 is AccessControl, ReentrancyGuard {
    ...
    constructor(
        ...
        _tokenImplementation = address(new ERC721Implementation());
    ...
    function createToken (
        ...
        ERC721Implementation(clone).initialize(msg.sender, name, symbol);
        return clone;
    }
