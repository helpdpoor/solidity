...
contract SyntrumVault is AccessControl {
    struct LockProfile {
    ...
    uint256 internal constant SHIFT_4 = 10000;
    ...
    function withdrawLockedAssets (
        ...
        uint256 taxAmount = amount * _tax / SHIFT_4;
        _depositProfiles[depositProfileId].lockedAmount = 0;
    ...
    function addDepositProfile (
        ...
        if (uintData[3] > 0) { // apr > 0, FSP
            yieldMaxAmount = uintData[1] * uintData[3] * uintData[2] / YEAR / SHIFT_4;
        } else {
    ...
    function _updateTotalYield (
        ...
        if (_depositProfiles[depositProfileId].tvl > 0) {
            _depositProfiles[depositProfileId].yieldPerToken += SHIFT_18
                * period
    ...
    function _calculateDynamicYield (
        ...
        uint256 yield = (yieldPerToken - _deposits[depositId].yieldPerTokenOffset)
            * _deposits[depositId].amount / SHIFT_18;
        return yield;
    }
